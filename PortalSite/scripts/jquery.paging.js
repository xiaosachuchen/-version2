    ...
    $.fn.extend({
        paging: function (options) {
            ...
            var defaults = {
                ...
                otherFontColor: "#999999",   //两边字体颜色
                centerFontHoverColor: "#9d0000",  //中间鼠标悬浮的字体颜色
                otherFontHoverColor: "#9d0000",  //两边鼠标悬浮的字体颜色
                currentFontColor: "#9d0000",    //当前选中页的字体颜色
                jumpFontColor: "#999999",          //跳转内部标签的字体颜色
                jumpFontHoverColor: "#9d0000",      // 跳转内部标签的悬浮字体颜色  
                currentPage: 1,             //当前页
                ...
                if (opts.animation) {  //滚动方式
                    ...
                    for (var i = 1; i <= opts.showPage; i++) {
                        if (i == opts.showPage - 1 && opts.showPage < opts.total)
                            $this.find(".centerBtns ul").append('<li><a value=' + i + ' class="more">····</a></li>');
