...
jQuery.extend({
		     ...
		     $('#TableData').bootstrapTable({
		      url: '/RIPSP/Chosen/favorites',
			    ...
			    uniqueId: 'seqid',
				 ...
				 { field: 'resremark', title: '资源描述'},
				 { field: 'createdtime', title: '创建时间'},
			      ]
		    });
	  },
	  Add: function () {
		   editurl = '/RIPSP/Chosen/favorites';
		     editmethod = 'Post';
		     $.FormInit();
		     $('#edit_modal').modal();
	  },
	  Edit:function(){
		  ...
		  editurl = '/RIPSP/Chosen/favorites/' + selrow[0].seqid;
		    editmethod = 'Put';
		    $.FormLoad(selrow);
		    $('#edit_modal').modal();
	  },
	  FormLoad:function(selrow){
		    ...
		    //修改时，在这里获取详情，再绑定表单
		    //$.ajax({
		  //    url: '/RIPSP/Chosen/favorites/' + selrow[0].seqid,
		    //    method: 'Get',
